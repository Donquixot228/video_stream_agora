...
class BroadcastPage extends StatefulWidget {
  ...
  const BroadcastPage({Key? key, required this.channelName, required this.isBroadcaster}) : super(key: key);
...
class _BroadcastPageState extends State<BroadcastPage> {
  ...
  List<Widget> _getRenderViews() {
    ...
    _users.forEach((int uid) => list.add(RtcRemoteView.SurfaceView(uid: uid,channelId: 'main',)));
    return list;
  }
